...
import 'package:group_chat_app/pages/chat/services/services.dart';
import 'package:group_chat_app/pages/chat/widgets/chat_widget.dart';
import 'package:group_chat_app/pages/chat/widgets/text_widget.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: Image.asset(AssetsManager.openaiLogo,color: Colors.white,scale: 1,),
        ),
